      ...
      foreach($Num in $Nums)
      {
        ...
        {            
            ...
            foreach($Node in $Nodes)
            {
                ...
                $User = New-AzureBatchComputeNodeUser -PoolId $PName -ComputeNodeId $Node.Id -Name 'config' -Password 'Kasakyr@' -ExpiryTime $Date -IsAdmin:$true -BatchContext $BCntx -Verbose
